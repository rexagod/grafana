"use strict";(self.webpackChunkgrafana=self.webpackChunkgrafana||[]).push([[2415],{"./public/app/core/hooks/useQueryParams.ts":(e,s,a)=>{a.d(s,{K:()=>i});var t=a("./packages/grafana-runtime/src/index.ts"),n=a("./.yarn/cache/react-npm-17.0.1-98658812fc-83b9df9529.zip/node_modules/react/index.js"),r=a("./.yarn/__virtual__/react-router-virtual-31642fe47a/0/cache/react-router-npm-5.2.1-ea754d7473-7daae084bf.zip/node_modules/react-router/esm/react-router.js");function i(){const{search:e}=(0,r.TH)();return[(0,n.useMemo)((()=>(0,t.locationSearchToObject)(e||"")),[e]),(0,n.useCallback)(((e,s)=>setImmediate((()=>t.locationService.partial(e,s)))),[])]}},"./public/app/features/alerting/unified/AlertGroups.tsx":(e,s,a)=>{a.r(s),a.d(s,{default:()=>H});var t=a("./.yarn/cache/react-npm-17.0.1-98658812fc-83b9df9529.zip/node_modules/react/index.js"),n=a("./.yarn/__virtual__/react-redux-virtual-8e30c710ae/0/cache/react-redux-npm-7.2.5-cf7e365145-04ac4a4178.zip/node_modules/react-redux/es/index.js"),r=a("./packages/grafana-ui/src/index.ts"),i=a("./public/app/core/hooks/useQueryParams.ts"),l=a("./public/app/features/alerting/unified/components/AlertingPageWrapper.tsx"),o=a("./public/app/plugins/datasource/alertmanager/types.ts"),c=a("./.yarn/__virtual__/@emotion-css-virtual-9fd25d72e0/0/cache/@emotion-css-npm-11.1.3-72aa05c30f-dc50283f65.zip/node_modules/@emotion/css/dist/emotion-css.esm.js"),d=a("./public/app/features/alerting/unified/components/AlertLabels.tsx"),p=a("./packages/grafana-data/src/index.ts"),u=a("./public/app/features/alerting/unified/components/silences/AmAlertStateTag.tsx"),m=a("./public/app/features/alerting/unified/components/DynamicTableWithGuidelines.tsx"),g=a("./public/app/features/alerting/unified/utils/misc.ts"),f=a("./public/app/features/alerting/unified/components/AnnotationDetailsField.tsx"),b=a("./.yarn/cache/react-npm-17.0.1-98658812fc-83b9df9529.zip/node_modules/react/jsx-runtime.js");const x=({alert:e,alertManagerSourceName:s})=>{const a=(0,r.useStyles2)(h);return(0,b.jsxs)(b.Fragment,{children:[(0,b.jsxs)("div",{className:a.actionsRow,children:[e.status.state===o.Z9.Suppressed&&(0,b.jsx)(r.LinkButton,{href:`${(0,g.eQ)("/alerting/silences",s)}&silenceIds=${e.status.silencedBy.join(",")}`,className:a.button,icon:"bell",size:"sm",children:"Manage silences"}),e.status.state===o.Z9.Active&&(0,b.jsx)(r.LinkButton,{href:(0,g.VN)(s,e.labels),className:a.button,icon:"bell-slash",size:"sm",children:"Silence"}),e.generatorURL&&(0,b.jsx)(r.LinkButton,{className:a.button,href:e.generatorURL,icon:"chart-line",size:"sm",children:"See source"})]}),Object.entries(e.annotations).map((([e,s])=>(0,b.jsx)(f.a,{annotationKey:e,value:s},e))),(0,b.jsxs)("div",{className:a.receivers,children:["Receivers:"," ",e.receivers.map((({name:e})=>e)).filter((e=>!!e)).join(", ")]})]})},h=e=>({button:c.css`
  ...
  `}),j=({alerts:e,alertManagerSourceName:s})=>{const a=(0,r.useStyles2)(y),n=(0,t.useMemo)((()=>[{id:"state",label:"State",renderCell:({data:e})=>(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)(u.G,{state:e.status.state}),(0,b.jsxs)("span",{className:a.duration,children:["for"," ",(0,p.intervalToAbbreviatedDurationString)({start:new Date(e.startsAt),end:new Date(e.endsAt)})]})]}),size:"190px"},{id:"labels",label:"Labels",renderCell:({data:{labels:e}})=>(0,b.jsx)(d.s,{className:a.labels,labels:e}),size:1}]),[a]),i=(0,t.useMemo)((()=>e.map((e=>({id:e.fingerprint,data:e})))),[e]);return(0,b.jsx)("div",{className:a.tableWrapper,"data-testid":"alert-group-table",children:(0,b.jsx)(m.F,{cols:n,items:i,isExpandable:!0,renderExpandedContent:({data:e})=>(0,b.jsx)(x,{alert:e,alertManagerSourceName:s})})})},y=e=>({tableWrapper:c.css`
  ...
  `,labels:c.css`
    padding-bottom: 0;
  `});var v,_=a("./public/app/features/alerting/unified/components/CollapseToggle.tsx"),$=a("./public/app/features/alerting/unified/components/alert-groups/AlertGroupHeader.tsx");const k=({alertManagerSourceName:e,group:s})=>{const[a,n]=(0,t.useState)(!0),i=(0,r.useStyles2)(N);return(0,b.jsxs)("div",{className:i.wrapper,children:[(0,b.jsxs)("div",{className:i.header,children:[(0,b.jsxs)("div",{className:i.group,"data-testid":"alert-group",children:[(0,b.jsx)(_.U,{isCollapsed:a,onToggle:()=>n(!a),"data-testid":"alert-group-collapse-toggle"}),Object.keys(s.labels).length?(0,b.jsx)(d.s,{className:i.headerLabels,labels:s.labels}):v||(v=(0,b.jsx)("span",{children:"No grouping"}))]}),(0,b.jsx)($.Z,{group:s})]}),!a&&(0,b.jsx)(j,{alertManagerSourceName:e,alerts:s.alerts})]})},N=e=>({wrapper:c.css`
    & + & {
  ...
  `});var S,w=a("./public/app/features/alerting/unified/components/AlertManagerPicker.tsx");const C=({className:e,onFilterChange:s,queryString:a})=>{const t=(0,r.useStyles2)(z);return(0,b.jsxs)("div",{className:e,children:[(0,b.jsxs)(r.Label,{children:[(0,b.jsx)(r.Tooltip,{content:S||(S=(0,b.jsxs)("div",{children:["Filter alerts using label querying, ex:",(0,b.jsx)("pre",{children:'{severity="critical", instance=~"cluster-us-.+"}'})]})),children:(0,b.jsx)(r.Icon,{className:t.icon,name:"info-circle",size:"xs"})}),"Search by label"]}),(0,b.jsx)(r.Input,{placeholder:"Search",defaultValue:a,onChange:e=>{const a=e.target;s(a.value)},"data-testid":"search-query-input"})]})},z=e=>({icon:c.css`
    margin-right: ${e.spacing(.5)};
  `});var G;const M=({onStateFilterChange:e,stateFilter:s})=>{const a=(0,r.useStyles2)(A),t=Object.entries(o.Z9).sort((([e],[s])=>e<s?-1:1)).map((([e,s])=>({label:e,value:s})));return(0,b.jsxs)("div",{className:a.wrapper,children:[G||(G=(0,b.jsx)(r.Label,{children:"State"})),(0,b.jsx)(r.RadioButtonGroup,{options:t,value:s,onChange:e})]})},A=e=>({wrapper:c.css`
    margin-left: ${e.spacing(1)};
  `});var B,E,F=a("./.yarn/cache/lodash-npm-4.17.21-6382451519-eb835a2e51.zip/node_modules/lodash/lodash.js");const O=({className:e,groups:s,groupBy:a,onGroupingChange:t})=>{const n=(0,F.uniq)(s.flatMap((e=>e.alerts)).flatMap((({labels:e})=>Object.keys(e)))).filter((e=>!(e.startsWith("__")&&e.endsWith("__")))).map((e=>({label:e,value:e})));return(0,b.jsxs)("div",{"data-testid":"group-by-container",className:e,children:[B||(B=(0,b.jsx)(r.Label,{children:"Custom group by"})),(0,b.jsx)(r.MultiSelect,{"aria-label":"group by label keys",value:a,placeholder:"Group by",prefix:E||(E=(0,b.jsx)(r.Icon,{name:"tag-alt"})),onChange:e=>{t(e.map((({value:e})=>e)))},options:n})]})};var I=a("./public/app/features/alerting/unified/hooks/useAlertManagerSourceName.ts");const L=({groups:e})=>{const[s,a]=(0,t.useState)(Math.floor(100*Math.random())),[n,l]=(0,i.K)(),{groupBy:o=[],queryString:c,alertState:d}=(0,g.lC)(n),p=`matcher-${s}`,[u,m]=(0,I.k)(),f=(0,r.useStyles2)(Z),x=!!(o.length>0||c||d);return(0,b.jsxs)("div",{className:f.wrapper,children:[(0,b.jsx)(w.P,{current:u,onChange:m}),(0,b.jsxs)("div",{className:f.filterSection,children:[(0,b.jsx)(C,{className:f.filterInput,queryString:c,onFilterChange:e=>l({queryString:e||null})},p),(0,b.jsx)(O,{className:f.filterInput,groups:e,groupBy:o,onGroupingChange:e=>l({groupBy:e.length?e.join(","):null})}),(0,b.jsx)(M,{stateFilter:d,onStateFilterChange:e=>l({alertState:e||null})}),x&&(0,b.jsx)(r.Button,{className:f.clearButton,variant:"secondary",icon:"times",onClick:()=>{l({groupBy:null,queryString:null,alertState:null}),setTimeout((()=>a(s+1)),100)},children:"Clear filters"})]})]})},Z=e=>({wrapper:c.css`
    border-bottom: 1px solid ${e.colors.border.medium};
...
//# sourceMappingURL=AlertGroups.787ecc600122eb73aeab.js.map